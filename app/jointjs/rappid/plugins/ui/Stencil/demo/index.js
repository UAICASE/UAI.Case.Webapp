...
stencil.on('drop:invalid', function(evt, cell) {

    console.log('drop:invalid', evt, cell);
});

stencil.on('filter', function(filteredGraph, group) {

    console.log('filter', filteredGraph, group);
});
